...
Adhearsion::Configuration.configure do |config|
  ...
  #default_dial_plan_file_name = 'dialplan.rb'
  ...
  # Load system Zanelle Config
  require File.join(File.dirname(File.expand_path(__FILE__)), '..', "components/zanelle/lib/zanelle/config.rb")
